---
layout: page
title: Embargo List Policy
breadcrumbs: true
---

## 1. Purpose

The Embargo List ("the List") allows trusted stakeholders to receive
*pre-publication* **CVE Records** for the Erlang/OTP, Elixir, Gleam, and related
...
* The List currently operates as **one** global group. In the future, the CNA
  may compartmentalize embargo lists by project when doing so improves
...
1. Send an email to **[cna@erlef.org](mailto:cna@erlef.org)** containing:
   ...
   * Email **address** to be added to the embargo list
     `eef-cna-embargo@groups.io`.
...
2. Applications are reviewed on a **continuous basis**; additional information
   may be requested.
3. Approved participants are subscribed to the private mailing list
   `eef-cna-embargo@groups.io`.

## 5. List Operations

* All **CVE Records** are distributed via the private mailing list
  `eef-cna-embargo@groups.io`.
* Only EEF CNA personnel may post new CVE Records.  
  Participants may coordinate by replying to embargo announcements on the list.
* Do **not** forward, mirror, or redistribute list messages.
